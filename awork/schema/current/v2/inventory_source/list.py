...
actions = {u'GET': {u'created': {u'filterable': True,
           ...
           u'POST': {u'credential': {u'default': None,
                     ...
                     u'description': {u'default': u'',
                                      ...
                                      u'required': False,
                                      u'type': u'string'},
                     u'group_by': {u'default': u'',
                                   u'ec2_group_by_choices': [[u'ami_id', u'Image ID'],
                                                             [u'availability_zone',
                                                              u'Availability Zone'],
                                                             [u'aws_account',
                                                              u'Account'],
                                   ...
                                   u'required': False,
                                   u'type': u'string'},
                     u'instance_filters': {u'default': u'',
                                           u'filterable': True,
                                           u'help_text': u'Comma-separated list of filter expressions (EC2 only). Hosts are imported when ANY of the filters match.',
                                           u'label': u'Instance filters',
                                           u'max_length': 1024,
                     ...
                     u'overwrite': {u'default': False,
                                    ...
                                    u'required': False,
                                    u'type': u'boolean'},
                     u'overwrite_vars': {u'default': False,
                                         u'filterable': True,
                                         u'help_text': u'Overwrite local variables from remote inventory source.',
                                         u'label': u'Overwrite vars',
                                         u'required': False,
                     ...
                     u'timeout': {u'default': 0,
                                  ...
                                  u'required': False,
                                  u'type': u'integer'},
                     u'update_cache_timeout': {u'default': 0,
                                               u'filterable': True,
                                               u'label': u'Update cache timeout',
                                               u'max_value': 2147483647,
                                               u'min_value': 0,
                                               u'required': False,
                                               u'type': u'integer'},
                     u'update_on_launch': {u'default': False,
                                           u'filterable': True,
                                           u'label': u'Update on launch',
                                           u'required': False,
                                           u'type': u'boolean'},
                     u'update_on_project_update': {u'default': False,
                                                   u'filterable': True,
                                                   u'label': u'Update on project update',
                                                   u'required': False,
                                                   u'type': u'boolean'},
