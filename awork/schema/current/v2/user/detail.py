...
actions = {u'GET': {u'created': {u'help_text': u'Timestamp when this user was created.',
                    ...
                    u'username': {u'filterable': True,
                                  ...
                                  u'label': u'Username',
                                  u'type': u'string'}},
           u'PUT': {u'email': {u'filterable': True,
                               u'label': u'Email address',
                               u'max_length': 254,
                               u'required': False,
                               u'type': u'string'},
                    u'first_name': {u'filterable': True,
                                    ...
                                    u'required': False,
                                    u'type': u'string'},
                    u'is_superuser': {u'default': False,
                                      u'filterable': True,
                                      u'help_text': u'Designates that this user has all permissions without explicitly assigning them.',
                                      u'label': u'Superuser status',
                                      u'required': False,
                                      u'type': u'boolean'},
                    u'is_system_auditor': {u'default': False,
                                           u'label': u'Is system auditor',
                                           u'required': False,
                                           u'type': u'boolean'},
                    u'last_name': {u'filterable': True,
                                   u'label': u'Last name',
                    ...
                    u'password': {u'default': u'',
                                  u'filterable': True,
                                  u'help_text': u'Write-only field used to change the password.',
                                  u'label': u'Password',
                                  u'required': False,
                                  u'type': u'string',
                                  u'write_only': True},
